...
class DataSource(Base):
    ...
    type = Column(VARCHAR(20), nullable=False, comment="数据库类型：mysql/postgresql/sqlite")
    host = Column(VARCHAR(255), nullable=False, comment="主机地址")
    port = Column(Integer, nullable=False, comment="端口")
    database_name = Column(VARCHAR(100), nullable=False, comment="数据库名")
    db_username = Column(VARCHAR(100), nullable=False, comment="数据库用户名")
    db_password = Column(VARCHAR(255), nullable=False, comment="数据库密码")
