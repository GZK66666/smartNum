...
| 📚 **RAGFLOW 知识库** | 集成 RAGFLOW 知识库，支持企业文档、规章制度、政策法规等语义检索 |
...
- **企业知识库**：存储企业规章制度、政策法规、公文文件等
- **语义检索**：基于 RAGFLOW 的向量检索，精准匹配相关内容
- **智能体集成**：AI 自主调用检索工具，结合结构化数据回答问题
...
集成 RAGFLOW 知识库，上传企业文档、规章制度、政策法规等，AI 通过语义检索获取相关知识。
